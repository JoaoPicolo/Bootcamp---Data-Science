...
# Gets relationship between Consumo and Idade
...
# Adjusts linear regression of Consumo in function of Idade
regressao_linear <- lm(Consumo ~ Idade, data = dados)
summary(regressao_linear)

# Test normality for regression residuals
shapiro.test(regressao_linear$residuals)

# Gets details of Renda Mensal
